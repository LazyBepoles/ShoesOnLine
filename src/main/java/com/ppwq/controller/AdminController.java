...
public class AdminController {
    ...
    public Map<String, Object> updateRole(@PathVariable("uid") int uid,@PathVariable("role") int role){
    ...
    public Map<String, Object> updatePurview(@PathVariable("uid") int uid,@PathVariable("purview") int purview){
        Map<String, Object> result = new HashMap<>();
